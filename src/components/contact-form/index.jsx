...
const ContactForm = (data) => {
  ...
  const onSubmit = (data, e) => {
    ...
    axios({
      method: "post",
      url: "https://getform.io/f/9387e6aa-e107-4bd3-a5ba-c2a583931101",
      data,
    })
      .then((_res) => {
  ...
  return (
    <div className="form-wrapper-one registration-area">
      <h3 className="mb--30">{dataFromJson.data["ContactUs"]}</h3>
      <form
      ...
      >
        ...
        <input
          ...
          style={{ display: "none !important" }} // Apply inline CSS styles to hide the input field
        />
        <Button type="submit" size="medium">
          {dataFromJson.data["SendMessage"]}
        </Button>
        {serverState.status && (
          <p
            className={`mt-4 font-14 ${
              !serverState.status.ok ? "text-danger" : "text-success"
            }`}
          >
